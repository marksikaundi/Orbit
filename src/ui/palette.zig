...
pub const catalog = [_]BuiltinEntry{
    ...
    .{ .action = .focus_prev_pane, .label = "Focus Previous Pane", .hint = "Ctrl+PageUp" },
    .{ .action = .close_pane, .label = "Close Pane", .hint = "Ctrl+Shift+K" },
    .{ .action = .zoom_pane, .label = "Zoom Pane", .hint = "Ctrl+Shift+Z" },
    ...
    .{ .action = .ssh_reconnect, .label = "SSH Reconnect", .hint = "last host" },
    .{ .action = .sync_now, .label = "Sync Config Now", .hint = "orbit sync" },
    .{ .action = .sync_push, .label = "Sync Config Push", .hint = "orbit sync push" },
    .{ .action = .sync_pull, .label = "Sync Config Pull", .hint = "orbit sync pull" },
    ...
    .{ .action = .check_updates, .label = "Check for Updates", .hint = "orbit update --check" },
    .{ .action = .update_orbit, .label = "Update Orbit", .hint = "orbit update" },
